...
function OfferProducts() {
    ...
    const { data, error } = useSWR('https://api.escuelajs.co/api/v1/products?offset=20&limit=40', fetcher)
    let navigation;
    ...
    console.log(data.map((i:any)=>i.images[0]));
    ...
    return (<section>
        <CountdownTimer countdownTimestampMs={1661123662000} />
        <Box>
            <Swiper
                dir="rtl"
                lazy={true}
