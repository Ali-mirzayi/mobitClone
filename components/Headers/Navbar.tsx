      ...
      <div className={styles.section}>
        ...
        <div className={styles.flex}>
          ...
          <Link href="/Cart" passHref>
            {/* <IconButton sx={{padding: "5px",margin:"10px", boxSizing: "content-box"}}> */}
              <LocalGroceryStoreIcon className={styles.item} sx={{ padding: "3px",marginRight:'5px',fontSize:"15px", boxSizing: "content-box" }} />
            {/* </IconButton> */}
          </Link>
