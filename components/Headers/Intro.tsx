...
const Intro = () => {
    ...
    const { data, isError, isLoading } = useQuery('Intro', () => fetcher('https://api.escuelajs.co/api/v1/products/12'))
    const { data: watch, isError: error, isLoading: loading } = useQuery('MissingIntro', () => fetcher('https://api.escuelajs.co/api/v1/products/9'))
