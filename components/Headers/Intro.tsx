...
const Intro = () => {
    ...
    const { data, isError, isLoading } = useQuery('Intro', () => fetcher('https://api.escuelajs.co/api/v1/products/47'))
    const { data: watch, isError: error, isLoading: loading } = useQuery('MissingIntro', () => fetcher('https://api.escuelajs.co/api/v1/products/57'))
    ...
    return (<>
        <div className={styles.container}>
            ...
            <a href={`/categories/${data.category.name}`}>
