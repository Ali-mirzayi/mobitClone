...
function Back() {
    ...
    return (
    <section dir="rtl" style={{ position: 'relative', marginTop: '20px' }}>
        <Box sx={{backgroundColor:'grey.100'}} className={styles.paper} onClick={topFunction}><div><p className={styles.goUp}>بازگشت به بالا</p><KeyboardArrowUpSharpIcon sx={{ fontSize: '35px' }} /></div></Box>
        <Box sx={{backgroundColor:'grey.100'}} className={styles.paperContainer}>
